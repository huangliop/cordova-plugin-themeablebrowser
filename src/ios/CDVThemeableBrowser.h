 ...
 */
 ...
 @interface CDVThemeableBrowserViewController : UIViewController <UIWebViewDelegate, CDVScreenOrientationDelegate, UIActionSheetDelegate,NJKWebViewProgressDelegate>{
     @private
     NSString* _userAgent;
 ...
 @property (nonatomic,strong) IBOutlet NJKWebViewProgressView* webViewProgressView;
